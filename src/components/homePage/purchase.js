  ...
  return (
    <Box w="100%" h="2346px" pos="relative">
      ...
      <Box
        ...
        pos="absolute"
      />
      <Container maxW="1440px" m="auto" pos="absolute">
        {/* section One */}
        <Flex
          w="100%"
        ...
        >
          <Box maxW="583px" mb={{ base: "20px", md: "0" }}>
            ...
            <Text className="para-text" color="#D4D2E8">
              The most reliable marketplace for buying and selling BIIG and SCOUR is our MegaloSwap
              platform; however, these items are also available on Uniswap (UNI) and PancakeSwap
              (CAKE). It is important to take into consideration that, apart from MegaloSwap,
              exchanges that support one might not support the other.
              ...
              should make sure to do some research on it beforehand to ensure that it is absolutely
